var multilang = {
    ...
    data : {
        "de" : {
            ...
            "projects": "Projekte",
            "contact": "Kontakt",
            "caption_title": "Front-End Entwickler",
            "caption_subtitle": "& Grafikdesigner",
            "caption_body": "Hallo, <br>Ich bin ein marokkanischer Front-End-Entwickler und Grafikdesigner mit mehr als vier Jahren Erfahrung. Ich bin auf HTML, CSS und JavaScript spezialisiert und erstelle dynamische und reaktionsschnelle Websites, die eine optimale Benutzererfahrung bieten. <br><br>Außerdem verfüge ich über eine solide Expertise im Grafikdesign, wobei ich Ästhetik und Benutzerfreundlichkeit für effektive visuelle Lösungen verbinde.",
        ...
        "en" : {
            ...
            "caption_body": "Hi There, <br> I’m a Moroccan Front-End Developer and Graphic Designer with over 4 years of experience, focused on creating visually appealing and functional designs. My expertise in HTML, CSS, and JavaScript enables me to develop dynamic and responsive websites, ensuring an engaging user experience across all devices. <br>I also have a strong background in graphic design, where I combine aesthetics with usability to deliver seamless visual solutions.",
